...
Descriptions:Alice has n candies, where the ith candy is of type candyType[i]. Alice noticed that she started to gain weight, so she visited a doctor.
...
test(distributeCandies([6, 6, 6, 6]), 1);
